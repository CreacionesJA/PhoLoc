...
/**
 * PreferenceFragment
 * Based on the platform's code with some removed features and a basic ListView
 * layout.
 * 
...
public abstract class PreferenceFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			mPreferenceManager = c.newInstance(this.getActivity(),
					FIRST_REQUEST_CODE);
		} catch (Exception e) {
		}
	}
	...
	public void addPreferencesFromIntent(Intent intent) {
		...
		try {
			...
			m.setAccessible(true);
			PreferenceScreen screen = (PreferenceScreen) m.invoke(
	...
	public void addPreferencesFromResource(int resId) {
		...
		try {
			...
			m.setAccessible(true);
			PreferenceScreen screen = (PreferenceScreen) m.invoke(
					mPreferenceManager, getActivity(), resId,
					getPreferenceScreen());
			setPreferenceScreen(screen);
		} catch (Exception e) {
		}
